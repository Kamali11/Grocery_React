...
import "../../Pages/ProductMenu/Grains";
import { grains } from "../../Data/GrainData";
import "./Product_Vegtable.css";
import { frequently } from "../../Data/GrainData";
...
const Product_Grains = () => {
  const { id } = useParams();
  let result = grains.filter((item) => item.id == id);
  //   console.log(result)
              ...
              <section className="right-content">
                <div className="par-first">
                  <div className="product-name">
                    ...
                    <p style={{ color: "#8a8a8a", fontSize: "19px" }}>Grain</p>
                  </div>
