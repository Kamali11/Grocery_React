...
import "../../Pages/ProductMenu/Frozenfood";
import { frozenfoods } from "../../Data/FrozenfoodData";
import "./Product_Vegtable.css";
import { frequently } from "../../Data/FrozenfoodData";
...
const Product_Frozenfoods = () => {
  const { id } = useParams();
  let result = frozenfoods.filter((item) => item.id == id);
  //   console.log(result)
              ...
              <section className="right-content">
                <div className="par-first">
                  <div className="product-name">
                    ...
                    <p style={{ color: "#8a8a8a", fontSize: "19px" }}>
                      Frozenfood
                    </p>
                  </div>
                  ...
                  ? frequently.map((item, id) => {
                      return (
                        <div className="products" key={id}>
                          <Link to={`/frozenfoods/${item.id}`}>
                            <img src={item.img} alt="..." />
                            <p style={{ color: "rgba(128, 128, 128, 0.779)" }}>
                              Frozenfood
                            </p>
                            <p className="tle-veg">{item.icecream_name}</p>
...
export default Product_Frozenfoods;
