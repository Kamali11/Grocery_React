...
import "../../Pages/ProductMenu/Oils";
import { oils } from "../../Data/OilData";
import "./Product_Vegtable.css";
import { frequently } from "../../Data/OilData";
...
const Product_Oils = () => {
  const { id } = useParams();
  let result = oils.filter((item) => item.id == id);
  //   console.log(result)
              ...
              <section className="right-content">
                <div className="par-first">
                  <div className="product-name">
                    ...
                    <p style={{ color: "#8a8a8a", fontSize: "19px" }}>Oils</p>
                  </div>
