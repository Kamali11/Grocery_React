...
import "../../Pages/ProductMenu/Nuts";
import { nuts } from "../../Data/NutData";
import "./Product_Vegtable.css";
import { frequently } from "../../Data/NutData";
...
const Product_Nuts = () => {
  const { id } = useParams();
  let result = nuts.filter((item) => item.id == id);
  //   console.log(result)
              ...
              <section className="right-content">
                <div className="par-first">
                  <div className="product-name">
                    ...
                    <p style={{ color: "#8a8a8a", fontSize: "19px" }}>Nut</p>
                  </div>
