...
import "../../Pages/ProductMenu/Juices";
import { juices } from "../../Data/JuiceData";
import "./Product_Vegtable.css";
import { frequently } from "../../Data/JuiceData";
...
const Product_Juices = () => {
  const { id } = useParams();
  let result = juices.filter((item) => item.id == id);
  //   console.log(result)
              ...
              <section className="right-content">
                <div className="par-first">
                  <div className="product-name">
                    ...
                    <p style={{ color: "#8a8a8a", fontSize: "19px" }}>Juice</p>
                  </div>
