...
import "../../Pages/ProductMenu/Snacks";
import { icecream, snacks } from "../../Data/SnackData";
import "./Product_Vegtable.css";
import { frequently } from "../../Data/SnackData";
              ...
              <section className="right-content">
                <div className="par-first">
                  <div className="product-name">
                    ...
                    <p style={{ color: "#8a8a8a", fontSize: "19px" }}>Snacks</p>
                  </div>
...
export default Products_Snacks;
