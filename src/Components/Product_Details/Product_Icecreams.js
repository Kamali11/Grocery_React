...
import "../../Pages/ProductMenu/Icecream";
import { icecream } from "../../Data/IcecreamData";
import "./Product_Vegtable.css";
import { frequently } from "../../Data/IcecreamData";
...
const Product_Icecreams = () => {
  const { id } = useParams();
  let result = icecream.filter((item) => item.id == id);
  //   console.log(result)
...
export default Product_Icecreams;
